...
class WeatherForecastService {
    ...
    void setMaker(RequestMaker maker) {
        this.maker = maker;
    }

    List<WeatherForecast> getForecastsForPlaces(List<String> places) {
    ...
    private WeatherForecast getCurrentForecast(WeatherForecastRequest request) {
        try {
    ...
    private List<WeatherForecast> getThreeDaysForecast(WeatherForecastRequest request) {
